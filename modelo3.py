...
model_checkpoint = ModelCheckpoint(filepath='/home/Documentos/Base_de_datos/Datos_guardados/model_bestII.h5',
...
plt.tight_layout()
plt.savefig('/home/Documentos/Base_de_datos/Datos_guardados/curvas_entrenamientoII.png')
plt.show()

# Guardar el modelo completo
model_path = '/home/Documentos/Base_de_datos/Datos_guardados/model_completeII.h5'
model.save(model_path)
print(f'Model complete saved to {model_path}')

# Guardar solo los pesos del modelo
weights_path = '/home/Documentos/Base_de_datos/Datos_guardados/weights_onlyII.h5'
